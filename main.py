...
path2 = "https://raw.githubusercontent.com/micropython/micropython-lib/master/micropython/umqtt.simple/umqtt/simple.py"

@when("click","#library2")
async def load_umqtt(event):
    if terminal.connected:
        data = await restapi.get(path2)
...
list         = document.getElementById('files2')
